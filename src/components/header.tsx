  ...
  return (
    <>
      <header className="max-w-4xl mx-auto my-6 flex justify-between px-4 sm:px-6 ">
        ...
        <button
          className="inline-flex justify-center items-center h-7 sm:h-12 rounded-full border border-transparent px-0 py-0 text-base font-medium text-white   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-100 sm:text-sm"
          onClick={() => toggle()}
        >
